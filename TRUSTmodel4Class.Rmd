...
#Tdat$tx3.efa1
Tdat$tx3.efa1 <- factor.scores(Tdat[,c(3,4,6)],efa1,impute = "median")$scores
...
My results so far had me questioning the use of a beta distribution when modeling my depedent variable.  As a result, I chose to step back and start reading a bit more about various alternatives.  Here were my resources:
...
5. and then....I went down an internet rabbit hole of Rasch models and such
...
## Model 1: Stan Latent Trust

```{r Model1Latent}
# stan code for m1
```

## Model 2: Stan Emergent Trust
