...
```{r 2M1, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r 2M2, echo=FALSE, message=FALSE, warning=FALSE}
p_grid <- seq( from=0 , to=1 , length.out=100 )
...
```{r 2M3, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r 2M4, echo=FALSE, message=FALSE, warning=FALSE}
c1 <- c("B","B")
c2 <- c("B","W")
c3 <- c("W","W")
